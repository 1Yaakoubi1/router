...
import MoviesDetails from './Movies/MovieDetails.js'
...
function App() {
  ...
  return (
    <div>
      <Navbar search={search} setSearch={setSearch} rate={rate} setRate={setRate} moviedata={moviedata} setmoviedata={setmoviedata} login={login} setLogin={setLogin}    >  </Navbar>
      {/* <Rating  rate = {rate} setRate = {setRate} /> */}
      {/* <Add moviedata={moviedata} setmoviedata={setmoviedata} /> */}
      
      <Route exact path='/' component={Home} />
      <Route exact path='/movies' render={()=> <ListMovies search={search} moviedata={moviedata} setmoviedata={setmoviedata} rate={rate} login={login} ></ListMovies>} />
      <Route path='/moviesDetails/:id' render={(props)=>  <MoviesDetails {...props}  moviedata={moviedata} login={login}></MoviesDetails>  } />
